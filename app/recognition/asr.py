...
class ASR:
    def __init__(self, model_arch, model_weight, model_priori_proba_file, fst_folder, acoustic_model_labels_file, grammerFileName = "G.fst",words_lexicon_file = Config.RECOGNITION_DIR+"ForcedAlignmnet/words_lexicon.txt", phones_lexicon_file = Config.RECOGNITION_DIR+"ForcedAlignmnet/phones_lexicon.txt"):
