...
import sys
sys.path.append("./Decoder/C++/PythonBinding/")
...
class ASR:
    def __init__(self, model_file, fst_folder, acoustic_model_labels_file, words_lexicon_file = "./ForcedAlignmnet/words_lexicon.txt", phones_lexicon_file = "./ForcedAlignmnet/phones_lexicon.txt"):
