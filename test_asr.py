...
python3 test_asr.py -model_arch ./Classifier/BLSTM_91/model_cpu.json -model_weights ./Classifier/BLSTM_91/weights.h5 -model_priori_proba_file ./Classifier/BLSTM_91/priori.txt -fst_folder ./Decoder/Graphs/200k-vocab/ -acoustic_model_labels_file ./Decoder/Graphs/200k-vocab/labels.ciphones -latticeBeam 4 -srcfile waves_test.txt -outfile pred_transcript.txt -reffile ref_transcript.txt
